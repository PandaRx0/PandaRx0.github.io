...
const MCQS = {
  ...
  'thyroid': [
    {
        "id": "q1",
        "question": "1. JM is a regular patient came to your private pharmacy carrying a lab. Test positive for TRABs, your most likely first thought would be:",
        "options": [
            {
                "id": "a",
                "text": "The patient is suffering from hypoadrenalism"
        ...
        "correctId": "c",
        "explanation": "TRAb (TSH receptor antibodies) are a marker for Graves' disease, an autoimmune cause of hyperthyroidism. The next step is to confirm the diagnosis by measuring thyroid hormone levels (T3, T4, TSH)."
    },
    {
        "id": "q2",
        "question": "2. OU is a hyperthyroid patient came to your private pharmacy carrying a prescription containing lugol's solution, he asks you; why did his surgeon write it before radical thyroidectomy, your answer will include all of the bellow except:",
        "options": [
            {
                "id": "a",
                "text": "To reduce the size of the gland"
        ...
        "correctId": "d",
        "explanation": "Lugol's solution (iodide) is given preoperatively to decrease the size and vascularity of the hyperthyroid gland, reducing surgical bleeding. It does not prevent the development of a hot nodule."
    },
    {
        "id": "q3",
        "question": "3. KL is a colleague pharmacist with suspected hypothyroidism his symptoms are all suggestive of his illness except:",
        ...
        "correctId": "b",
        "explanation": "Hypothyroidism slows down metabolic processes, leading to constipation, bradycardia, and fatigue. Diarrhea is a symptom of hyperthyroidism."
    },
    {
        "id": "q4",
        "question": "4. All of the following are facial expressions of hypothyroidism except:",
        ...
        "correctId": "d",
        "explanation": "Exophthalmos (protrusion of the eyes) is a classic sign of Graves' disease (hyperthyroidism). The other options are features of hypothyroidism."
    },
    {
        "id": "q5",
        "question": "5. DR is suffering from coarse hair, bradycardia, raised TSH, and lower than normal T4 level his physician argues about the possibility of pituitary failure (secondary hypothyroidism) your opinion is that this rare condition should be suspected if:",
        "options": [
            {
                "id": "a",
                "text": "The level of T4 is decreased with an inappropriately normal or low TSH levels."
            },
            {
                "id": "b",
                "text": "The level of T4 is increased with an inappropriately normal or low TSH levels."
            },
            {
                "id": "c",
                "text": "The level of T4 is decreased with a high TSH levels."
            },
            {
                "id": "d",
                "text": "Both of T4 and TSH levels are increased"
        ...
        "correctId": "a",
        "explanation": "In primary hypothyroidism, TSH is elevated. In secondary (central) hypothyroidism, the pituitary fails to produce TSH, so the TSH level is low or inappropriately normal despite low T4."
    },
    {
        "id": "q6",
        "question": "6. CS is a patient suffering from a chronic disease for which his physician has ordered a T3 injection which he considers as the first choice drug in this condition only, according to your opinion this condition would be:",
        "options": [
            {
                "id": "a",
                "text": "Chronic hypothyroidism"
        ...
        "correctId": "c",
        "explanation": "In myxedema coma (severe, life-threatening hypothyroidism), IV liothyronine (T3) may be preferred in some cases due to its faster onset of action compared to levothyroxine (T4)."
    },
    {
        "id": "q55",
        "question": "55. Myxedema coma is a serious condition. Treatment of myxedema coma includes all the following EXCEPT :",
        "options": [
            {
                "id": "a",
                "text": "Thyroxine"
        ...
        "correctId": "c",
        "explanation": "Treatment of myxedema coma includes thyroid hormone replacement (thyroxine), IV fluids, hydrocortisone (for possible adrenal insufficiency), and supportive care including ventilation. Magnesium sulfate is not a standard treatment."
    },
    {
        "id": "q61",
        "question": "61. Many treatments can be used for treating Hyperthyroidism. Pharmacological treatment of hyperthyroidism include",
        "options": [
            {
                "id": "a",
                "text": "Thioureas"
        ...
        "correctId": "e",
        "explanation": "All listed options are used in the management of hyperthyroidism. Thioureas (methimazole, PTU) and iodides inhibit hormone synthesis/release, adrenergic blockers control symptoms, and radioactive iodine is an ablative therapy."
    },
    {
        "id": "q63",
        ...
        "correctId": "a",
        "explanation": "Propylthiouracil (PTU) is the preferred antithyroid drug during the first trimester of pregnancy because methimazole and carbimazole are associated with teratogenic effects (e.g., aplasia cutis). Radioactive iodine is absolutely contraindicated in pregnancy."
    },
    {
        "id": "q74",
        ...
        "correctId": "a",
        "explanation": "Serum TSH is the most sensitive and specific marker for monitoring levothyroxine replacement therapy. The goal is to normalize TSH levels."
    },
    {
        "id": "q98",
        ...
        "correctId": "c",
        "explanation": "Subacute granulomatous thyroiditis (de Quervain's) is typically painful, not painless. Painless thyroiditis is a different condition."
    },
    {
        "id": "q100",
        "question": "100. A 45-year-old woman has received a diagnosis of Graves' disease. She is reluctant to try ablative therapy and wants to attempt oral pharmacotherapy first. Her thyroid laboratory values today include TSH 0.25 mIU/L (normal 0.5-4.5 mIU/L) and a free T4 concentration of 3.6 ng/dL (normal 0.8-1.9 ng/dL), She is anxious and always feels warm when others say it is too cold. Which would be considered the best drug for initial treatment of her condition?",
        "options": [
            {
                "id": "a",
                "text": "Lugol's solution."
        ...
        "correctId": "d",
        "explanation": "Methimazole is the preferred first-line antithyroid drug for most patients with Graves' disease due to its once-daily dosing and better safety profile compared to PTU (except in pregnancy and thyroid storm)."
    },
    {
        "id": "q37",
        "question": "37. Regarding Grave's disease. All of the following are true EXCEPT:",
        "options": [
            {
                "id": "a",
                "text": "It is a curable condition"
            ...
            {
                "id": "c",
                "text": "Exophthalmos, pretibial myxedema, and thyroid acropathy are extrathyroidal findings"
            },
            {
                "id": "d",
                "text": "It is characterized by high levels of T3, T4 and TSH"
        ...
        "correctId": "d",
        "explanation": "In Graves' disease, TSH is suppressed (low) due to negative feedback from high T3 and T4 levels. TSH is not high."
    },
    {
        "id": "q38",
        "question": "38. Regarding levothyroxine. All of the following are true EXCEPT:",
        "options": [
            {
                "id": "a",
                "text": "It is chemically stable, relatively inexpensive, active when given orally, and free of antigenicity"
        ...
        "correctId": "d",
        "explanation": "Levothyroxine is not used to treat thyroid storm. Thyroid storm is a hyperthyroid emergency treated with antithyroid drugs, beta-blockers, iodides, and corticosteroids."
    },
    {
        "id": "q59",
        "question": "59. Elderly female patient with a history of Grave's disease, treated with radioactive Iodine previously, presented with symptoms of heat intolerance and weight loss. Her laboratory values show a reduction in TSH and an abnormally high T4. What is the best treatment recommendation right now?",
        "options": [
            {
                "id": "a",
                "text": "Start methimazole"
        ...
        "correctId": "a",
        "explanation": "The patient has recurrent hyperthyroidism after radioactive iodine. Methimazole is the appropriate treatment to control the hyperthyroidism."
    },
    {
        "id": "q62",
        "question": "62. T.R is 32 years old patient with history of Hashimoto's disease, she is maintained on thyroxin 75 mcg daily, she was presented to the emergency department with hypothermia, reduced level of consciousness, bradycardia and periorbital puffiness. What is the best management plan?",
        "options": [
            {
                "id": "a",
                "text": "Propyl thiouracil IV followed by iodide and Corticosteroid and other conservative measures"
            },
            {
                "id": "b",
                "text": "Thyroxin IV followed by hydrocortisone and other conservative measures"
            },
            {
                "id": "c",
                "text": "High dose of oral Methimazole"
        ...
        "correctId": "b",
        "explanation": "The patient is presenting with myxedema coma. Treatment requires IV levothyroxine (or liothyronine) and IV hydrocortisone (to cover possible adrenal insufficiency), along with supportive measures."
    },
    {
        "id": "q69",
        "question": "69. All the following treatments for thyrotoxicosis are non-safe in pregnancy EXCEPT:",
        "options": [
            {
                "id": "a",
                "text": "methimazole"
            ...
            {
                "id": "e",
                "text": "Propyl-thiouracil"
            }
        ],
        "correctId": "e",
        "explanation": "Propylthiouracil (PTU) is the preferred antithyroid drug during the first trimester of pregnancy. Methimazole and carbimazole are associated with teratogenic risks."
    },
    {
        "id": "q72",
        "question": "72. R.P is 45 years old female with History of Hypertension and Arrhythmia and she is now maintained on Valsartan and Amiodarone with bisoprolol, she is now experiencing new symptoms like cold intolerance, weight gain, fatigue and hair loss. Her doctor told her that she may have thyroid issue due to amiodarone. What is the most likely effect of amiodarone on thyroid gland?",
        "options": [
            {
                "id": "a",
                "text": "Hypothyroidism"
        ...
        "correctId": "a",
        "explanation": "Amiodarone is rich in iodine and can cause both hyperthyroidism and hypothyroidism. The symptoms described (cold intolerance, weight gain, fatigue) are classic for hypothyroidism."
    },
    {
        "id": "q86",
        "question": "86. Related to the antithyroid pharmacotherapy. The only conditions for which \u03b2-blockers are the primary therapy for thyrotoxicosis are those associated with:",
        "options": [
            {
                "id": "a",
                "text": "Thyroiditis"
        ...
        "correctId": "a",
        "explanation": "In thyroiditis (e.g., subacute or silent thyroiditis), the thyrotoxicosis is due to release of preformed hormones, not increased synthesis. Therefore, antithyroid drugs are ineffective, and beta-blockers are used as primary therapy for symptom control."
    },
    {
        "id": "q11",
        "question": "11. CC, is a 65-year-old woman who has gained 6 kg of weight over the past year. She also has cardiac problem, fatigue, polyneuropathy, slow speech, constipation, depression, and can't stand the cold. Her skin is pale, cool, dry, and thick. The serum T4 (total) is 3.5 mcg/dL (normal range: 4.5-10.9 mcg/dL), the T3 level is 53 ng/dL (normal range: 60-181 ng/dL), and the blood TSH level is 6.2 mIU/L (normal range: 0.5-4.7 mIU/L). The proper initial treatment for this case will be :",
        "options": [
            {
                "id": "a",
                "text": "Levothyroxine 25 mcg/day."
        ...
        "correctId": "a",
        "explanation": "The patient has hypothyroidism with cardiac issues. In elderly patients with cardiac disease, levothyroxine should be started at a low dose (e.g., 25 mcg/day) and titrated slowly to avoid precipitating angina or arrhythmias."
    },
    {
        "id": "q29",
        "question": "29. Regarding thyroid gland disorders, all of the following are potential causes of hypothyroidism EXCEPT:",
        "options": [
            {
                "id": "a",
                "text": "Hashimoto's thyroiditis"
        ...
        "correctId": "b",
        "explanation": "Ketoconazole is a steroidogenesis inhibitor that can cause adrenal insufficiency, but it is not a common cause of hypothyroidism."
    },
    {
        "id": "q35",
        "question": "35. Regarding thyroid storm, all the following are characteristics of thyroid storm EXCEPT:",
        "options": [
            {
                "id": "a",
                "text": "Tachycardia"
        ...
        "correctId": "d",
        "explanation": "Thyroid storm is a hypermetabolic state characterized by tachycardia, tachypnea, fever, dehydration, and GI symptoms like nausea, vomiting, and diarrhea. Constipation is associated with hypothyroidism."
    },
    {
        "id": "q37",
        "question": "37. A 60-years-old female with a known history of hypothyroidism present to the emergency department in a stuporous state. She has a low body temperature of 33.5\u00b0C, bradycardia, and respiratory depression. Laboratory tests confirmed diagnosis of myxedema coma. What is the appropriate initial treatment for this patient?",
        "options": [
            {
                "id": "a",
                "text": "IV bolus levothyroxine"
        ...
        "correctId": "d",
        "explanation": "Myxedema coma is treated with IV thyroid hormone replacement (levothyroxine or liothyronine) and IV hydrocortisone to cover possible adrenal insufficiency, along with supportive measures."
    },
    {
        "id": "q50",
        "question": "50. B.S is 41 years old male with negative medical history, he presented with palpitation, anxiety, heat intolerance, excessive sweating and mild hair loss, upon examination he had an elevated T3, T4 with undetectable TSH. Ultrasound showed a multinodular goiter. One of the following treatment options may exacerbate the condition of this patient?",
        "options": [
            {
                "id": "a",
                "text": "Propranolol"
        ...
        "correctId": "e",
        "explanation": "In patients with toxic multinodular goiter, administration of iodide can exacerbate hyperthyroidism (the Jod-Basedow phenomenon) by providing substrate for autonomous hormone production."
    },
    {
        "id": "q57",
        "question": "57. Regarding treatment of hyperthyroidism, which of the following are considered to be ablative therapy for thyrotoxicosis due to Graves' disease ?",
        "options": [
            {
                "id": "a",
                "text": "Thyroidectomy only"
        ...
        "correctId": "e",
        "explanation": "Ablative therapies for Graves' disease are those that permanently destroy thyroid tissue: radioactive iodine ablation and surgical thyroidectomy."
    },
    {
        "id": "q78",
        "question": "78. Regarding hyperthyroidism, what is the type of hyperthyroidism due to ingestion of exogenous thyroid hormone",
        "options": [
            {
                "id": "a",
                "text": "Painful subacute thyroiditis"
        ...
        "correctId": "c",
        "explanation": "Thyrotoxicosis factitia is hyperthyroidism caused by the ingestion of exogenous thyroid hormone, either intentionally or inadvertently."
    },
    {
        "id": "q95",
        "question": "95. A 25 years old non pregnant female was treated successfully from hyperthyroidism using methimazole. Few months later, relapse occurs. The preferred second line pharmacologic treatment would be",
        "options": [
            {
                "id": "a",
                "text": "Second course of methimazole"
            ...
            {
                "id": "c",
                "text": "Switch to propyl thiouracil"
            },
            {
                "id": "d",
                "text": "Thyroidectomy"
        ...
        "correctId": "b",
        "explanation": "After relapse of hyperthyroidism, definitive therapy (radioactive iodine or thyroidectomy) is usually preferred. Radioactive iodine is often the second-line treatment for a non-pregnant woman."
    },
    {
        "id": "q96",
        "question": "96. Iodide is very useful in various forms of thyrotoxicosis. Despite the multiple indications of iodide in thyrotoxicosis, it is contraindicated in",
        "options": [
            {
                "id": "a",
                "text": "Preparing patients for thyroidectomy"
        ...
        "correctId": "d",
        "explanation": "Iodide can exacerbate hyperthyroidism in patients with toxic multinodular goiter and autonomous nodules (Jod-Basedow phenomenon). It is used preoperatively in Graves' disease."
    },
    {
        "id": "q8",
        "question": "8. Regarding thyrotoxicosis. All of the following hyperthyroid patients are candidates for methimazole therapy as first-line treatment over propylthiouracil EXCEPT......",
        "options": [
            {
                "id": "a",
                "text": "A 55-year-old male with thyroid storm"
        ...
        "correctId": "a",
        "explanation": "Propylthiouracil (PTU) is preferred over methimazole in thyroid storm and during the first trimester of pregnancy. Methimazole is the first-line for most other situations."
    },
    {
        "id": "q14",
        ...
        "correctId": "b",
        "explanation": "In thyroiditis, the thyrotoxicosis is due to release of preformed hormones, not increased synthesis. Antithyroid drugs are ineffective, so beta-blockers are used as primary therapy for symptom control."
    },
    {
        "id": "q21",
        ...
        "options": [
            {
                "id": "a",
                "text": "Young patients with long-standing disease and patients older than 45 years without known cardiac disease should be started on 50 mcg daily"
            },
            {
                "id": "b",
                "text": "The initial daily dose for older patients with cardiac disease is 25 mcg/day titrated upward in increments of 25 mcg at monthly intervals"
            },
            {
                "id": "c",
                "text": "The average maintenance dose for most adults is about 125 mcg/day"
            ...
            {
                "id": "e",
                "text": "Cholestyramine, and dietary fiber supplements may impair the absorption of levothyroxine from the GI tract"
            }
        ],
        "correctId": "d",
        "explanation": "Levothyroxine requirements often increase during pregnancy, and dose adjustments are necessary to maintain TSH in the normal range. Regular monitoring is essential."
    },
    {
        "id": "q47",
        ...
        "options": [
            ...
            {
                "id": "d",
                "text": "increase dose of thyroxin"
            },
            {
                "id": "e",
                "text": "decrease the dose of thyroxin"
            }
        ],
        "correctId": "d",
        "explanation": "Aluminum hydroxide and sucralfate can bind levothyroxine in the GI tract, reducing its absorption. If these medications are necessary, the levothyroxine dose may need to be increased, and doses should be separated by several hours."
    },
    {
        "id": "q59",
        ...
        "correctId": "b",
        "explanation": "Graves' disease causes hyperthyroidism, characterized by high free T4 and T3 with suppressed TSH due to negative feedback."
    },
    {
        "id": "q65",
        ...
        "correctId": "c",
        "explanation": "Radioactive iodine is contraindicated in pregnancy and in women who are actively trying to conceive, as it can affect the fetal thyroid. Pregnancy should be avoided for at least 6-12 months after RAI."
    },
    {
        "id": "q4",
        "question": "4. Hyperthyroidism can be artificially created or developed. The hyperthyroidism caused by ingestion of excessive amounts of thyroid hormone is defined as;",
        "options": [
            {
                "id": "a",
                "text": "Painful subacute thyroiditis."
        ...
        "correctId": "b",
        "explanation": "Thyrotoxicosis factitia is hyperthyroidism caused by the ingestion of exogenous thyroid hormone."
    },
    {
        "id": "q18",
        "question": "18. A.D is a patient 31 years old with benign thyroid mass that produces thyroid hormone independent of pituitary and TSH control. He is considered to have:",
        "options": [
            {
                "id": "a",
                "text": "TSH secreting pituitary tumor"
        ...
        "correctId": "d",
        "explanation": "A benign thyroid mass that produces thyroid hormone independently of TSH control is called an autonomous (toxic) thyroid nodule."
    },
    {
        "id": "q27",
        "question": "27. Agranulocytosis is a significant side effect of methimazole. If agranulocytosis occurs, it develops suddenly during the first",
        "options": [
            {
                "id": "a",
                "text": "One month"
        ...
        "correctId": "c",
        "explanation": "Agranulocytosis from methimazole or PTU typically occurs suddenly within the first 3 months of therapy. Patients should be advised to report fever or sore throat immediately."
    },
    {
        "id": "q35",
        "question": "35. A 32 years old, 9 weeks pregnant, suffering from hyperthyroidism since she was 25 years old. Her physician asked you to advise him about the suitable treatment for her, knowing that she was on methimazole since first diagnosed.",
        "options": [
            {
                "id": "a",
                "text": "remain on methimazole"
            ...
            {
                "id": "c",
                "text": "Switch to propyl thiouracil only"
            },
            {
                "id": "d",
                "text": "low dose and methimazole and propyl thiouracil"
            },
            {
                "id": "e",
                "text": "propyl thiouracil and propranolol"
            }
        ],
        "correctId": "c",
        "explanation": "During the first trimester of pregnancy, propylthiouracil (PTU) is preferred over methimazole due to a lower risk of teratogenic effects."
    },
    {
        "id": "q39",
        "question": "39. Lugol solution was used in hyperthyroidism disease, which situation the iodide is not recommended?",
        "options": [
            {
                "id": "a",
                "text": "prepare a patient with Graves' disease for surgery."
        ...
        "correctId": "b",
        "explanation": "Iodide is not recommended in toxic multinodular goiter because it can exacerbate hyperthyroidism (Jod-Basedow phenomenon)."
    },
    {
        "id": "q58",
        "question": "58. Ahmed, a 59-year-old baker with exhaustion, weight gain, cold sensitivity, constipation, cardiac problems, and obesity, has hypothyroidism due to low T4 and T3 levels and high TSH. The proper treatment will be:",
        "options": [
            {
                "id": "a",
                "text": "Levothyroxine 25 mcg/day."
        ...
        "correctId": "a",
        "explanation": "The patient has hypothyroidism with cardiac problems. In patients with cardiac disease, levothyroxine should be started at a low dose (e.g., 25 mcg/day) and titrated slowly."
    },
    {
        "id": "q97",
        "question": "97. G.M; 45-years old female patient admitted to emergency department with high fever, tachycardia, tachypnea, dehydration and coma. Decompensated thyrotoxicosis was seemed to be responsible for her recent complain. Which of the following is most appropriate treatment plan for this patient now",
        "options": [
            {
                "id": "a",
                "text": "Use large dose of PTU with esmolol, hydrocortisone in addition to other supportive measures."
            },
            {
                "id": "b",
                "text": "Use large dose of Methimazole with esmolol, hydrocortisone in addition to other supportive measures."
            },
            {
                "id": "c",
                "text": "Use large dose of PTU with verapamil, hydrocortisone in addition to other supportive measures."
            },
            {
                "id": "d",
                "text": "Use large dose of Methimazole with propranolol, hydrocortisone in addition to other supportive measures."
            },
            {
                "id": "e",
                "text": "Use large dose of Methimazole with diltiazem, hydrocortisone in addition to other supportive measures."
            }
        ],
        "correctId": "a",
        "explanation": "This is thyroid storm. PTU is preferred over methimazole in thyroid storm because it also inhibits peripheral conversion of T4 to T3. Esmolol (short-acting beta-blocker) is used for rapid control of adrenergic symptoms, and hydrocortisone is given to treat possible adrenal insufficiency."
    }
],
  'adrenal_disorders': [
    {
